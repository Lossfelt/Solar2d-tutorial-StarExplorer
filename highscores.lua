...
highscoresSound = audio.loadStream( "audio/Midnight-Crawlers_Looping.wav" )
...
function scene:show( event )
	...
	elseif ( phase == "did" ) then
		...
		audio.play( highscoresSound, {channel=1, loops=-1} )
	end
end
